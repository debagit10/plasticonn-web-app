...
const Change_Details = () => {
  ...
  const update = async () => {
    ...
    try {
      const response = await api.put("api/center/profile", changedFields);
      ...
      localStorage.setItem(
        "user",
        JSON.stringify({
          id: response.data.data.center._id,
          role: response.data.data.center.role,
        }),
      );
    } catch (error: any) {
